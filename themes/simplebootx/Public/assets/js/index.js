...
$(function(){
    ...
    (function navli(){
        ...
        var name=url.toString().split("a=")[1];
        $(".nav li[data="+name+"]").find("a").addClass("navover");
    })();
    //主页背景图
    (function bgimgauto(){
        var timer=null;
    ...
    (function listmouseover(){
        ...
        oLi.attr("index","50"*$(this).index()).on("mouseover",function(){
            var num=$(this).index();
    ...
    $.ajax({
        type:"GET",
        url:"themes/simplebootx/Public/assets/data/news.json",
        dataType: "json",
